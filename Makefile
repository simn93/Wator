...
# secondo frammento 
FILE_DA_CONSEGNARE2= wator.c visualizer.c watorprocess.c auxfun.c auxfun.h watorscript

# terzo frammento 
FILE_DA_CONSEGNARE3= wator.c wator.h visualizer.c watorprocess.c auxfun.c auxfun.h watorscript README.txt RELAZIONE-SOL.pdf
...
wator: watorprocess.c wator.c wator.h auxfun.c auxfun.h
	$(CC) $(CFLAGS) -c wator.c
	$(CC) $(CFLAGS) -c auxfun.c
	$(CC) $(CFLAGS) -pthread -c watorprocess.c
	$(CC) wator.o auxfun.o watorprocess.o -lpthread -o wator
	rm ./watorprocess.o
	rm ./auxfun.o
	rm ./wator.o
	
visualizer: visualizer.c wator.h wator.c auxfun.c auxfun.h
	$(CC) $(CFLAGS) -c wator.c
	$(CC) $(CFLAGS) -c auxfun.c
	$(CC) $(CFLAGS) -pthread -c visualizer.c
	$(CC) wator.o auxfun.o visualizer.o -lpthread -o visualizer
	rm ./visualizer.o
	rm ./auxfun.o
	rm ./wator.o
